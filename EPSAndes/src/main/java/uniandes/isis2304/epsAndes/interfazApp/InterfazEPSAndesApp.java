...
public class InterfazEPSAndesApp extends JFrame implements ActionListener
{
	...
	public void registrarRolesUsuario()
	{
		try
		{
			...
			JTextField otroROl = new JTextField();
			JTextField nombreROL = new JTextField();

			Object message[] = {

					"Ingrese el rol: ", combo,
					"Ingrese otro id rol diferente: ", otroROl,
					"Ingrese el nombre del rol", nombreROL, 
			...
			{
				String NombreROl = nombreROL.getText().toString();

				VORol rol = epsAndes.registrarRol(NombreROl);
				if(rol != null) {
