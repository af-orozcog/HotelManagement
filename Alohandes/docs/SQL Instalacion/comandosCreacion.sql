...
CREATE TABLE HOTELERIA(
    ...
    HORA_APERTURA VARCHAR2(255),
    HORA_CIERRE VARCHAR2(255),
    PRIMARY KEY(ID),
    FOREIGN KEY(ID) REFERENCES OPERADOR,
...
CREATE TABLE VIVIENDA(
    ...
    PRIMARY KEY (ID),
    FOREIGN KEY (OPERADOR) REFERENCES OPERADOR(ID),
	CHECK (TIPO IN ('HABITACION','CUARTO', 'ESPORADICO','APARTAMENTO'))
);
...
CREATE TABLE OFERTA(
    ...
    HABILITADA NUMBER NOT NULL,
    PRIMARY KEY (ID),
    FOREIGN KEY (VIVIENDA) REFERENCES VIVIENDA(ID),
    CHECK (PRECIO > 0),
	CHECK (FECHAINICIO < FECHAFIN),
    CHECK (PERIODO IN ('DIAS','SEMANAS','MESES','SEMESTRES')),
    CHECK (HABILITADA = 0 OR HABILITADA = 1)
);
...
CREATE TABLE RESERVA(
	...
	FOREIGN KEY (OFERTA) REFERENCES OFERTA(ID),
    FOREIGN KEY (CLIENTE) REFERENCES CLIENTE(ID),
    FOREIGN KEY (COLECTIVA) REFERENCES RESERVA_COLECTIVA(ID),
    PRIMARY KEY(ID),
    CHECK (FIN > INICIO),
    CHECK (PERIODO_ARRENDAMIENTO IN ('DIAS','SEMANAS','MESES','SEMESTRES'))
);
