...
//			e.printStackTrace();
    	...
    	try
		{
			...
			int mes1 = 12;
			int anio1 = 2020;
			Ganancias ganancias1 = pm.adicionarGanancias(cantidad1, new DATE(new Timestamp(2000, 1, 1, 1, 0, 0, 0)), op.getId());
			...
			int mes2 = 12;
			int anio2 = 2020;
			Ganancias ganancias2 = pm.adicionarGanancias(cantidad2, new DATE(new Timestamp(2000, 1, 1, 1, 0, 0, 0)), op.getId());
			lista = pm.darGanancias();
